...
//método funcional
fun adicionarImagemEvento(cartas:List<Card>, frente:HTMLCollection, contador:Int){
    if(contador<18){
        ...
        adicionarImagemEvento(cartas, frente, contador+1)
    }
}
...
fun abreFechaTudo(){
    ...
    val lista = MutableList(36){ cont -> div[cont]!!.classList.toggle("aberta") }
}